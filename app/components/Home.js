                    ...
                    <div className='container'>
                        ...
                        journey that transcends the ordinary.</span> Explore our diverse data, embrace our innovative
                            ...
                            <img className="about-us-section__image"
                                 src='https://images.pexels.com/photos/1581384/pexels-photo-1581384.jpeg?cs=srgb&dl=pexels-reneasmussen-1581384.jpg&fm=jpg' width="400"
                                 alt='Restaurant' />
                        </div>
                    </div>
                </section>
                <section className='attitude-section section' id='attitude-section'>
                    <div className='container'>
                        ...
                        <ul className='attitude-section__list'>
                            <li className='attitude-section__item'>
                                <article className='attitude-card'>
                                    <img className='attitude-card__photo'
                                         src='https://www.fujitsu.com/global/imagesgig5/ai-banner-800x450_tcm100-7204059_tcm100-6286607-32.jpg' alt='AI-System' />
                                        <div>
                            ...
                            <li className='attitude-section__item'>
                                <article className='attitude-card'>
                                    <img className='attitude-card__photo' src='https://res.cloudinary.com/grand-canyon-university/image/fetch/w_750,h_564,c_fill,g_faces,q_auto/https://www.gcu.edu/sites/default/files/media/images/Blog/medical-studies-sciences/Nutritionist.jpg' alt='Nutritionist'/>
                                        <div>
                                ...
                                <ul className='menu-section__list swiper-wrapper'>
                                    <li className='swiper-slide'>
                                        <article className='menu-card'>
                                            <img className="menu-card__image" src='https://betterme.world/articles/wp-content/uploads/2020/12/shutterstock_1260483340.jpg' alt="Diets" />
